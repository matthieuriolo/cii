<?php
namespace cii\components\drivers\Kohana;
...
abstract class Image {
        ...
        public static function factory($file, $driver = NULL)
        {
                ...
                // Set the class name
                $class = 'cii\components\drivers\Image_'.$driver;
         ...
         * @return  void
         */
        abstract protected function _do_watermark($watermark, $offset_x, $offset_y, $opacity);
