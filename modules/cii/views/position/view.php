...
<p class="pull-right">
    <?= Html::a(Yii::p('cii', 'Update'), [\Yii::$app->seo->relativeAdminRoute('position/update'), ['id' => $model->id]], ['class' => 'btn btn-primary']) ?>
    <?= Html::a(Yii::p('cii', 'Delete'), [\Yii::$app->seo->relativeAdminRoute('position/delete'), ['id' => $model->id]], [
