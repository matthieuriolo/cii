...
<div class="language-view">
    <p class="pull-right">
        <?= Html::a(Yii::p('cii', 'Update'), [\Yii::$app->seo->relativeAdminRoute('language/update'), ['id' => $model->id]], ['class' => 'btn btn-primary']) ?>
        <?= Html::a(Yii::p('cii', 'Delete'), [\Yii::$app->seo->relativeAdminRoute('language/delete'), ['id' => $model->id]], [
